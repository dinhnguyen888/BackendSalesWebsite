...
public class SecurityConfig {
	...
	private final String[] END_POINT = {"/api/v1/auth/**", "/v3/api-docs/**", "/swagger-ui/**",
										"/auth/**", "/categories/**", "/vnpay-payment", "/submitOrder" , "/api/orders", "/api/products/pages", "/api/products/searchByName", "/api/products/searchByManufacturer", "/api/products/**", "/api/reviews/**" , "/ws/**"};
